...
1.@Model は「このクラスをアプリの保存データとして扱う」宣言し、これをつけると、保存、読み込み、更新、削除を自動で管理してくれます。

**もしこう書かなかったら：**
（この部分を省略したり変えたりすると何が起きるか。実際に試した結果があればここに書く）

1.@Modelを書かないとMemo はただの普通のクラスになってしまい、SwiftDataで保存、読み込み、@Queryで取得できなくなる
...
1.@Binding を書かないと設定変更をしても親画面に反映されない
