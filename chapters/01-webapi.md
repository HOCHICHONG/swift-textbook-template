...
**実験1：**
- やったこと：適当な検索ワードを入力、例：ffafafavqfa
- 結果：ちゃんとエラーメッセージがでった
- わかったこと：ユーザーの誤操作によるエラーの防ぐ重要性
...
1. **質問：**
   ...
   **得られた理解：**
    ...
    非同期処理によって「人間の操作速度」と「コンピュータの待ち時間」を分離しているので、待ち時間を感じさせない

2. **質問：**

     guard letがなかった頃にエンジニアたちはどうやってプログラムを制御してきたですか？
   
   **得られた理解：**

     guard let がない時代は「if let」と「ネスト」で頑張っていた
