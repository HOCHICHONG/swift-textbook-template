...
## 「写真を選んで、そのときの現在地と一緒に保存し、地図と一覧で管理できるアプリ」
...
タブで機能を分けることで、コードが見やすくなる、機能の表示がぐじゃぐじゃにはならない。

**もしこう書かなかったら：**

1.もしタブビューを使わなかったらどうなる？
```
もし1画面に全部詰め込むと、
...
1.?（オプショナル型）データがnil(空のデータ)という可能性があるので、？をつけないとデータにnilが入り実行時エラーでアプリがクラッシュしてしまう。

2.guard letと使ってエラーが発生する前にそれを弾く
